...
gulp.task("default", function () {
  gulp.watch("scss/**/*.scss", gulp.series("sass-consultez", "rtl-consultez", "consultez-shop", "rtl-consultez-shop", "sass-custom-admin-consultez"));
});

//Task 1 - scss to css
gulp.task("sass-consultez", function () {
  return gulp
...
gulp.task("rtl-consultez", function () {
  return gulp
...
gulp.task("sass-custom-admin-consultez", function () {
  return gulp
