<?php consultez_enqueue_script_lightgallery(); ?>
<?php consultez_enqueue_script_owl_carousel(); ?>
<?php $gallery_images = consultez_get_rwmb_group_advanced( 'consultez_' . "blog_mb_pf_gallery_settings",  "gallery_images", null, false, 'all', 'large' );?>
