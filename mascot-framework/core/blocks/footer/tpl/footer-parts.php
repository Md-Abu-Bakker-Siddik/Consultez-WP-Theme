	...
	<?php
	/**
	* consultez_before_footer hook.
	*
	*/
	do_action( 'consultez_before_footer' );
	?>
	<footer id="footer" class="footer <?php echo esc_attr( $footer_classes );?>">
	<?php
		/**
		* consultez_footer_start hook.
		*
		*/
		do_action( 'consultez_footer_start' );
	?>
		<div class="footer-widget-area">
			<?php if ( isset($footer_widget_area) && !empty($footer_widget_area) && mascot_core_consultez_plugin_installed() ) { ?>
	...
	<?php
		/**
		* consultez_footer_end hook.
		*
		*/
		do_action( 'consultez_footer_end' );
	?>
	</footer>
	<?php
	/**
	* consultez_after_footer hook.
	*
	*/
	do_action( 'consultez_after_footer' );
	?>