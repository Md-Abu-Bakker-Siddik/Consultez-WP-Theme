<?php
	...
	$quote_author = consultez_get_rwmb_group( 'consultez_' . "blog_mb_pf_quote_settings", 'quote_author' );
	$quote_position = consultez_get_rwmb_group( 'consultez_' . "blog_mb_pf_quote_settings", 'quote_position' );
?>
