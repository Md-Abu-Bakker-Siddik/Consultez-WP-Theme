...
if (!function_exists('consultez_sidebar_widget_title_line_bottom_color')) {
	/**
	 * Generate CSS codes for Sidebar Widget Title Custom Line Bottom Color
	 */
	function consultez_sidebar_widget_title_line_bottom_color() {
		...
		if( $consultez_redux_theme_opt['sidebar-settings-sidebar-title-line-bottom-theme-colored'] != '' ) {
			return;
		}
	...
	add_action('consultez_dynamic_css_generator_action', 'consultez_sidebar_widget_title_line_bottom_color');
}