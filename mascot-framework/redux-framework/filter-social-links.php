<?php
	...
	$enabled_social_links = apply_filters( 'consultez_redux_config_social_links_enabled', $enabled_social_links );
	...
	$backup_social_links = apply_filters( 'consultez_redux_config_social_links_backup', $backup_social_links );
	...
	$redux_config_social_links_arraylist_1 = array(
		array(
			...
			'type'     => 'sorter',
			'title'    => esc_html__( 'Social Links Ordering', 'consultez' ),
			'desc'     => '',
			'compiler' => 'true',
			'options'	=> array(
		...
		array(
			...
			'type'     => 'select',
			'title'    => esc_html__( 'Open links in', 'consultez' ),
			'subtitle' => '',
			'desc'     => '',
			'options'	=> array(
		...
		array(
			...
			'type'     => 'section',
			'title'    => esc_html__( 'Social URLs', 'consultez' ),
			'subtitle' => '',
