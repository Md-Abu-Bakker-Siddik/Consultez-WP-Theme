...
<?php
$links = array(
	'mascot-about'			  	=> esc_html__( 'About', 'consultez' ),
	'mascot-docs' 				=> esc_html__( 'Support & Help', 'consultez' ),
	'mascot-faq' 				=> esc_html__( 'FAQ', 'consultez' ),
	'mascot-system-status'     	=> esc_html__( 'System Status', 'consultez' ),
);
